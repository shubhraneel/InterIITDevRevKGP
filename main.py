...
if __name__ == "__main__":
	...
	tokenizer = AutoTokenizer.from_pretrained(config.model.model_path, TOKENIZERS_PARALLELISM=True, max_length = config.model.max_length) # add local_files_only=local_files_only if using server
