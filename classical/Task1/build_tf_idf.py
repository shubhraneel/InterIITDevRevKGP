...
if __name__ == '__main__':
    ...
    parser.add_argument('out_dir', type=str, default="data-dir/",
    ...
    if args.theme_wise:
        ...
        for theme in themes:
            ...
            count_matrix, doc_dict = get_count_matrix(
                args, 'sqlite', {
                    'db_path': f"data-dir/theme_wise/{theme.casefold()}/sqlite_para.db"}
            )
            ...
            basename = os.path.splitext(os.path.basename(
                f"data-dir/theme_wise/{theme.casefold()}/sqlite_para.db"))[0]
            basename += ('-tfidf-ngram=%d-hash=%d-tokenizer=%s' %
                        (args.ngram, args.hash_size, 'corenlp'))
            filename = os.path.join(
                f"data-dir/theme_wise/{theme.casefold()}/", basename)
