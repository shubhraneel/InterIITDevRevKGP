...
class GRU(pl.LightningModule):
    def __init__(self, vocab_size, config, train_dataloader = None, validation_dataloader = None, test_dataloader = None):
        ...
        self.gru = nn.GRU(config.model.params.input_size, self.hidden_size, self.num_layers, batch_first=True)
...
class LSTM(pl.LightningModule):
    def __init__(self, vocab_size, config, train_dataloader = None, validation_dataloader = None, test_dataloader = None):
        ...
        self.lstm = nn.LSTM(config.model.params.input_size, self.hidden_size, self.num_layers, batch_first=True, bidirectional=True)
        self.fc = nn.Linear(self.hidden_size*2, config.model.params.num_classes)
...
class GRUModel(Base_Model):
    def __init__(self, config, tokenizer = None, logger=None):
        ...
        self.lstm = GRU(self.vocab_size, self.config)
