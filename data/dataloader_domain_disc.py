...
class SQuAD_Dataset_title_label(Dataset):
    def __init__(self, config, df, tokenizer, hide_tqdm=False):
        ...
        self.data["title_label"] = [self.title_dict[x] for x in self.data['title_id']]
        # self.theme_para_id_mapping = self._get_theme_para_id_mapping()

        data_keys = ["answers", "context", "question",
                     "title", "question_id", "context_id", "title_id", "title_label"]
